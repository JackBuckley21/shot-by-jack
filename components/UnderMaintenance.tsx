    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{ color: "rgba(240, 235, 228, 0.85)" }}>
              Status: Updating archive & color grades
            </span>
          </div>
        </motion.div>
        ...
        <motion.div variants={itemVariants}>
          ...
          >
            Under Maintenance<span style={{ color: "var(--accent)" }}>.</span>
          </h1>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="max-w-2xl">
          ...
          >
            The portfolio is temporarily offline while new shoots and backend updates are being deployed. Check back shortly.
          </p>
        </motion.div>
